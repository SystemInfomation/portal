...
export default function LockedPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* Floating orbs */}
      <div className="absolute top-20 left-20 w-64 h-64 bg-red-500/10 rounded-full blur-3xl animate-pulse-slow" />
      <div className="absolute bottom-20 right-20 w-96 h-96 bg-orange-500/10 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: '1s' }} />
      ...
      <div className="max-w-3xl w-full space-y-10 relative z-10">
        ...
        <div className="flex justify-center">
          <div className="relative group">
            {/* Glow effect */}
            <div className="absolute inset-0 bg-gradient-to-r from-red-500 to-orange-500 blur-2xl opacity-50 group-hover:opacity-70 transition-opacity animate-pulse" />
            
            {/* Lock container */}
            <div className="relative bg-gradient-to-br from-red-500/20 to-orange-500/20 p-12 rounded-3xl border border-red-500/30 backdrop-blur-xl shadow-2xl">
              <Lock className="w-28 h-28 text-red-400 animate-bounce-gentle" />
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4 text-center">
          <h1 className="text-5xl md:text-6xl font-black bg-gradient-to-r from-red-400 via-orange-400 to-red-400 bg-clip-text text-transparent animate-gradient-x">
            Access Restricted
          </h1>
          <p className="text-2xl md:text-3xl text-red-300 font-bold tracking-wide">
            🔒 After School Hours Lockdown
          </p>
        </div>

        {/* Main message card */}
        <div className="bg-gradient-to-br from-red-950/50 to-orange-950/50 border border-red-500/30 rounded-3xl p-10 space-y-8 backdrop-blur-xl shadow-2xl">
          {/* Current time */}
          <div className="flex items-center justify-center gap-4 text-white">
            <Clock className="w-8 h-8 text-red-400 animate-pulse" />
            <div className="text-center">
              <p className="text-sm text-white/60 uppercase tracking-wider">Current Time</p>
          ...
          <div className="space-y-6 text-center">
            ...
            <div className="bg-black/30 rounded-2xl p-6 border border-red-500/20">
              ...
              <p className="text-sm text-white/50 mt-2">Eastern Time</p>
            </div>
          </div>
          ...
          <div className="text-center space-y-3">
            <div className="flex items-center justify-center gap-3 text-green-400">
              ...
              <p className="text-sm uppercase tracking-wider font-semibold">Next Unlock</p>
            </div>
            <p className="text-xl font-bold text-white">{nextUnlockTime}</p>
